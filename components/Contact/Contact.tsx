...
export default function Contact() {
  return (
    <div className="flex container content-center flex flex-col md:flex-row justify-evenly">
      ...
      <div className="flex flex-col mt-3 md:mt-0 pl-3 md:pl-0 md:flex-row">
        <div className="flex flex-col md:mr-24">
          ...
          <div className="flex flex-row items-center mb-10">
            <a href="https://www.instagram.com/kapeeshkappykap/">
              <i className="icon-instagram mr-6 text-3xl md:text-6xl" />
            </a>
            <a
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-row items-center mb-10">
            <a href="https://steamcommunity.com/profiles/76561198041254623/">
              <i className="icon-steam2 mr-6 text-3xl md:text-6xl" />
            </a>
            <a
